...
public:
	...
	//Función llamada cuando el actor està listo para trabajar
	virtual void BeginPlay() override;

	//Función que retorna el pawn escogido por el usuario
	UClass* GetPlayerPawnClass();

	
	//FRuncion que ejecuta el servidor y enviada por el cliente para que el servidor sepa que pawn quiere usar el usuario(el contenido de pawn serà validado en el servidor para que este entre las possibles opciones)
